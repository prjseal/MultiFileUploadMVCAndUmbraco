...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "a1b263a3af9cab47")]
...
#pragma warning restore 0109
	...
	/// <summary>UploadExample</summary>
	[PublishedContentModel("uploadExample")]
	public partial class UploadExample : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "uploadExample";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public UploadExample(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<UploadExample, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
	}
